/**
 * Die Klasse erstellt das Tutorial.
 *
...
public class Spielanleitung {
     ...
     *
     * Es werden die beiden verwendeten GUI MainGUI und QuestionFreeAnswer initalisiert.
     */
     ...
     *
     * Zudem werden in einer Timeline die unterschiedlichen Phasen des Spiels
     * vorgestellt.
     *
    ...
    public void startSpielanleitung(Stage stage1) {
        ...
        guiMC.labelTaskCount.setVisible(false);
        guiMC.labelLevel.setText("Wir zeigen dir jetzt die beiden Antwortmöglichkeiten.");
        guiMC.goOn.setVisible(false);
        guiMC.labelCorrectAnswer.setVisible(false);
        guiMC.labelWrongAnswer.setVisible(false);
        ...
        startMC = new Timeline(
                ...
                new KeyFrame(Duration.seconds(5.0), evt ->
                        guiMC.labelLevel.setText("Die erste Antwortmöglichkeit ist die Auswahl mit Knopfdruck.")
                ),
        ...
        correctAnswerMC = new Timeline(
                new KeyFrame(Duration.seconds(0.1), evt ->
                {
                    ...
                    guiMC.labelQuestion.setText("Toll gemacht! Die korrekte Antwort ist: 4:00 Uhr.");
                }),
        ...
        startFA = new Timeline(
                new KeyFrame(Duration.seconds(0.1), evt -> {
                    ...
                    guiFA.labelTaskCount.setVisible(false);
                    guiFA.labelCorrectAnswer.setVisible(false);
                    guiFA.labelWrongAnswer.setVisible(false);
                ...
                new KeyFrame(Duration.seconds(0.2), evt -> guiFA.labelLevel.setText("Bei der zweiten Antwortmöglichkeit, musst du die Antwort eintippen.")),
                new KeyFrame(Duration.seconds(5.0), evt -> {
